...
public class YourSolver implements Solver<Board> {
    ...
    private static final String USER_NAME = "example@epam.com";
...
//        WebSocketRunner.runOnServer("192.168.1.1:8080", // to use for local server
      WebSocketRunner.runOnServer("epam-challenge.lou.bet:8080/codenjoy-contest/ws", // to use for local server
